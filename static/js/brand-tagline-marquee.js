(function () {
    ...
    function measureMarquee(wrap) {
        var track = wrap.querySelector(".topbar-brand-tagline-track, .landing-brand-tagline-track");
        if (!track) return;

        var items = track.querySelectorAll(".topbar-brand-tagline-item, .landing-brand-tagline-item");
    ...
    function initMarquees() {
        document.querySelectorAll(".topbar-brand-tagline, .landing-brand-tagline").forEach(function (wrap) {
            measureMarquee(wrap);
